...
- 🔄 **Backup & Restore**: Local CSV backup and restore functionality
- 📤 **Data Export**: Export transactions and records to CSV
- 📧 **Feedback**: Direct email feedback integration
- 🛠️ **Settings**: Enhanced settings with restore options
