...
import 'package:moneymanager/src/services/app_dialogs.dart';
...
class _AnalysisScreenState extends ConsumerState<AnalysisScreen>
    with TickerProviderStateMixin, AppDialogsMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: AppDrawer(
        onDeleteReset: () => showDeleteResetDialog(context),
        onFeedback: () => showFeedbackDialog(context),
        onCloudStorage: () => showCloudStorageDialog(context),
        onAbout: () => showAboutAppDialog(context),
      ),
